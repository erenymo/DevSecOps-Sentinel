        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Modules_Workspaces_WorkspaceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicenseRiskScore = table.Column<double>(type: "double precision", nullable: false),
                    SbomOutput = table.Column<string>(type: "jsonb", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Scans_Modules_ModuleId",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Purl = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Components_Scans_ScanId",
                        column: x => x.ScanId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VexStatements_Components_ComponentId",
                        column: x => x.ComponentId,
                        principalTable: "Components",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VexStatements_Vulnerabilities_VulnerabilityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Scans_ModuleId",
                table: "Scans",
                column: "ModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_VexStatements_ComponentId",
                table: "VexStatements",
                column: "ComponentId");

            migrationBuilder.CreateIndex(
                name: "IX_VexStatements_VulnerabilityId",
                table: "VexStatements",
